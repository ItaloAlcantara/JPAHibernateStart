...
public class PopulaMovimentacao {
	...
	public static void main(String[] args) {
		...
		movimentacao1.setConta(manager.find(Conta.class,26));
		...
		movimentacao2.setConta(manager.find(Conta.class,27));
		...
		movimentacao3.setConta(manager.find(Conta.class,25));
		...
		movimentacao4.setConta(manager.find(Conta.class,23));
		...
		movimentacao5.setConta(manager.find(Conta.class,25));
		...
		movimentacao6.setConta(manager.find(Conta.class,29));
		...
		movimentacao7.setConta(manager.find(Conta.class,24));
		...
		movimentacao8.setConta(manager.find(Conta.class,28));
		...
		movimentacao9.setConta(manager.find(Conta.class,30));
		...
		movimentacao10.setConta(manager.find(Conta.class,30));
		...
		movimentacao11.setConta(manager.find(Conta.class,25));
		...
		movimentacao12.setConta(manager.find(Conta.class,27));
